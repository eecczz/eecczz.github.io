...
유튜브 클론 프로젝트에서 고민했던 미디어 처리 문제를 백엔드와 클라우드 파이프라인 관점으로 확장한 작업입니다. 영상 메타데이터 저장, 업로드 API, 비동기 변환, 재생 URL 제공을 나누어 설계하며 미디어 서비스의 기본 구조를 학습했습니다.
...
### AWS 변환 파이프라인
![AWS 변환 파이프라인](detail-cloud.jpg)
S3, Lambda, MediaConvert를 활용해 비동기 영상 변환 흐름을 구상했습니다.

### HLS 재생
![HLS 재생](detail-hls.jpg)
