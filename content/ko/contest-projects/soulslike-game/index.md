...
모바일 조작 화면에서 플레이어의 회피·스태미나·연속 공격과 보스의 패턴 전투를 한 흐름으로 구성했습니다. 전투 장면에서는 체력 UI와 공격 이펙트가 실제 판정 시점과 함께 동작합니다.

![보스와 근접 전투를 진행하는 모바일 게임 화면](featured.png)

![경기장에서 전투 시스템을 확인하는 플레이 화면](detail-combat.png)
