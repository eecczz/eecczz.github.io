...
sections:
  - block: markdown
    content:
      ...
      text: |
        <section class="portfolio-hero-v2">
          <p class="portfolio-kicker">BACKEND · AI · INTERACTIVE SOFTWARE</p>
          <h1>창의적이고 편리한 기능을<br>만듭니다.</h1>
          <p class="portfolio-hero-copy">
            Spring Boot를 주력으로 FastAPI·NestJS·Node.js를 활용하고,
            Unity 게임과 AI 모델까지 다루는 황선우의 개발 포트폴리오입니다.
          </p>
          <div class="portfolio-proof-line">
